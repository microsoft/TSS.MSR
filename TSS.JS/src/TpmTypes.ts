...
/*
 * This file is automatically generated from the TPM 2.0 rev. 1.61 specification documents.
...
export class TPML_ACT_DATA extends TpmStructure implements TPMU_CAPABILITIES 
{
    ...
    toTpm(buf: TpmBuffer) : void
    {
        buf.arrayToTpm<TPMS_ACT_DATA>(this.actData, 4);
    }
    
    /** TpmMarshaller method */
    fromTpm(buf: TpmBuffer) : void
    {
        this.actData = buf.arrayFromTpm(TPMS_ACT_DATA, 4);
    }
...
export class TPMS_CAPABILITY_DATA extends TpmStructure
{
    constructor(
        /**
        * the capability data (One of TPML_ALG_PROPERTY, TPML_HANDLE, TPML_CCA, TPML_CC, TPML_CC, TPML_PCR_SELECTION, TPML_TAGGED_TPM_PROPERTY, TPML_TAGGED_PCR_PROPERTY, TPML_ECC_CURVE, TPML_TAGGED_POLICY, TPML_ACT_DATA)
        */
