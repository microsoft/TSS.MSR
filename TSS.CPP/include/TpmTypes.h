...
enum class ImplementationConstants : UINT32
{
    ...
    MAX_CAP_CC = UINT32(0x19A/*TPM_CC::LAST*/),
    ...
    MAX_ACT_DATA = UINT32(ImplementationConstants::MAX_CAP_DATA) / 0xC /*sizeof(TPMS_ACT_DATA)*/
};
/// <summary>
...
enum class Implementation : UINT32
{
    ...
    /// </summary>
    CONTEXT_ENCRYPT_ALGORITHM = UINT32(0x6/*ALG_ID_VALUE::AES_VALUE*/),
    /// <summary>
    ...
    RSA_MAX_PRIME = (UINT32(ImplementationConstants::MAX_RSA_KEY_BYTES)/2),
    RSA_PRIVATE_SIZE = (UINT32(Implementation::RSA_MAX_PRIME) * 5),
...
inline TPMA_ACT operator|(TPMA_ACT _a, TPMA_ACT _b) { return static_cast<TPMA_ACT>(static_cast<UINT32>(_a) + static_cast<UINT32>(_b)); }
/// <summary>
...
/// (One of [TPMS_KDF_SCHEME_MGF1, TPMS_KDF_SCHEME_KDF1_SP800_56A, TPMS_KDF_SCHEME_KDF2, TPMS_KDF_SCHEME_KDF1_SP800_108, TPMS_SCHEME_HASH, TPMS_NULL_KDF_SCHEME])
/// </summary>
...
/// </summary>
class _DLLEXP_ TPMS_ACT_DATA : public TpmStructureBase
{
    friend class StructMarshallInfo;
    /// <summary>
    /// a permanent handle
    ...
    public: virtual TpmTypeId GetTypeId() const;
    protected: virtual void* ElementInfo(int elementIndex, int arrayIndex, int& arraySize, TpmStructureBase*& pElem, int newArraySize);
    public: TPMS_ACT_DATA& operator=(const TPMS_ACT_DATA& rhs);
    public: TPMS_ACT_DATA(const TPMS_ACT_DATA& rhs);
    public:
    TPMS_ACT_DATA();
...
class _DLLEXP_ TPML_CC : public virtual TPMU_CAPABILITIES 
{
    ...
    public: TPML_CC(
        const vector<TPM_CC>& commandCodes
    );
};
/// <summary>
...
class _DLLEXP_ TPML_CCA : public virtual TPMU_CAPABILITIES 
{
    ...
    public: TPML_CCA(
        const vector<TPMA_CC>& commandAttributes
    );
};
/// <summary>
...
class _DLLEXP_ TPML_ALG : public TpmStructureBase
{
    ...
    public: TPML_ALG(
        const vector<TPM_ALG_ID>& algorithms
    );
};
/// <summary>
...
class _DLLEXP_ TPML_HANDLE : public virtual TPMU_CAPABILITIES 
{
    ...
    public: TPML_HANDLE(
        const vector<TPM_HANDLE>& handle
    );
};
/// <summary>
...
class _DLLEXP_ TPML_DIGEST : public TpmStructureBase
{
    ...
    public: TPML_DIGEST(
        const vector<TPM2B_DIGEST>& digests
    );
};
/// <summary>
...
class _DLLEXP_ TPML_PCR_SELECTION : public virtual TPMU_CAPABILITIES 
{
    ...
    public: TPML_PCR_SELECTION(
        const vector<TPMS_PCR_SELECTION>& pcrSelections
    );
};
/// <summary>
...
class _DLLEXP_ TPML_ALG_PROPERTY : public virtual TPMU_CAPABILITIES 
{
    ...
    public: TPML_ALG_PROPERTY(
        const vector<TPMS_ALG_PROPERTY>& algProperties
    );
};
/// <summary>
...
class _DLLEXP_ TPML_TAGGED_TPM_PROPERTY : public virtual TPMU_CAPABILITIES 
{
    ...
    public: TPML_TAGGED_TPM_PROPERTY(
        const vector<TPMS_TAGGED_PROPERTY>& tpmProperty
    );
};
/// <summary>
...
class _DLLEXP_ TPML_TAGGED_PCR_PROPERTY : public virtual TPMU_CAPABILITIES 
{
    ...
    public: TPML_TAGGED_PCR_PROPERTY(
        const vector<TPMS_TAGGED_PCR_SELECT>& pcrProperty
    );
};
/// <summary>
...
class _DLLEXP_ TPML_ECC_CURVE : public virtual TPMU_CAPABILITIES 
{
    ...
    public: TPML_ECC_CURVE(
        const vector<TPM_ECC_CURVE>& eccCurves
    );
};
/// <summary>
...
class _DLLEXP_ TPML_TAGGED_POLICY : public virtual TPMU_CAPABILITIES 
{
    ...
    public: TPML_TAGGED_POLICY(
        const vector<TPMS_TAGGED_POLICY>& policies
    );
};
/// <summary>
...
class _DLLEXP_ TPML_ACT_DATA : public virtual TPMU_CAPABILITIES 
{
    ...
    public: virtual TpmTypeId GetTypeId() const;
    protected: virtual void* ElementInfo(int elementIndex, int arrayIndex, int& arraySize, TpmStructureBase*& pElem, int newArraySize);
    public: TPML_ACT_DATA& operator=(const TPML_ACT_DATA& rhs);
    public: TPML_ACT_DATA(const TPML_ACT_DATA& rhs);
    public:
    TPML_ACT_DATA();
    ...
    public: TPML_ACT_DATA(
        const vector<TPMS_ACT_DATA>& actData
    );
};
/// <summary>
...
class _DLLEXP_ TPMS_KDF_SCHEME_MGF1 : public virtual TPMS_SCHEME_HASH, public virtual TPMU_KDF_SCHEME 
{
    ...
    public: virtual TpmTypeId GetTypeId() const;
    protected: virtual void* ElementInfo(int elementIndex, int arrayIndex, int& arraySize, TpmStructureBase*& pElem, int newArraySize);
    public: TPMS_KDF_SCHEME_MGF1& operator=(const TPMS_KDF_SCHEME_MGF1& rhs);
    public: TPMS_KDF_SCHEME_MGF1(const TPMS_KDF_SCHEME_MGF1& rhs);
    public:
...
class _DLLEXP_ TPMS_KDF_SCHEME_KDF1_SP800_56A : public virtual TPMS_SCHEME_HASH, public virtual TPMU_KDF_SCHEME 
{
    ...
    public: virtual TpmTypeId GetTypeId() const;
    protected: virtual void* ElementInfo(int elementIndex, int arrayIndex, int& arraySize, TpmStructureBase*& pElem, int newArraySize);
    public: TPMS_KDF_SCHEME_KDF1_SP800_56A& operator=(const TPMS_KDF_SCHEME_KDF1_SP800_56A& rhs);
    public: TPMS_KDF_SCHEME_KDF1_SP800_56A(const TPMS_KDF_SCHEME_KDF1_SP800_56A& rhs);
    public:
...
class _DLLEXP_ TPMS_KDF_SCHEME_KDF2 : public virtual TPMS_SCHEME_HASH, public virtual TPMU_KDF_SCHEME 
{
    ...
    public: virtual TpmTypeId GetTypeId() const;
    protected: virtual void* ElementInfo(int elementIndex, int arrayIndex, int& arraySize, TpmStructureBase*& pElem, int newArraySize);
    public: TPMS_KDF_SCHEME_KDF2& operator=(const TPMS_KDF_SCHEME_KDF2& rhs);
    public: TPMS_KDF_SCHEME_KDF2(const TPMS_KDF_SCHEME_KDF2& rhs);
    public:
...
class _DLLEXP_ TPMS_KDF_SCHEME_KDF1_SP800_108 : public virtual TPMS_SCHEME_HASH, public virtual TPMU_KDF_SCHEME 
{
    ...
    public: virtual TpmTypeId GetTypeId() const;
    protected: virtual void* ElementInfo(int elementIndex, int arrayIndex, int& arraySize, TpmStructureBase*& pElem, int newArraySize);
    public: TPMS_KDF_SCHEME_KDF1_SP800_108& operator=(const TPMS_KDF_SCHEME_KDF1_SP800_108& rhs);
    public: TPMS_KDF_SCHEME_KDF1_SP800_108(const TPMS_KDF_SCHEME_KDF1_SP800_108& rhs);
    public:
...
class _DLLEXP_ TPML_AC_CAPABILITIES : public TpmStructureBase
{
    ...
    public: TPML_AC_CAPABILITIES(
        const vector<TPMS_AC_OUTPUT>& acCapabilities
    );
};
/// <summary>
...
class _DLLEXP_ IncrementalSelfTestResponse : public TpmStructureBase
{
    ...
    public: IncrementalSelfTestResponse(
        const vector<TPM_ALG_ID>& toDoList
    );
};
/// <summary>
...
/// </summary>
class _DLLEXP_ TPM2_ECC_Encrypt_REQUEST : public TpmStructureBase
{
    friend class StructMarshallInfo;
    /// <summary>
    ...
    public: virtual TpmTypeId GetTypeId() const;
    protected: virtual void* ElementInfo(int elementIndex, int arrayIndex, int& arraySize, TpmStructureBase*& pElem, int newArraySize);
    public: TPM2_ECC_Encrypt_REQUEST& operator=(const TPM2_ECC_Encrypt_REQUEST& rhs);
    public: TPM2_ECC_Encrypt_REQUEST(const TPM2_ECC_Encrypt_REQUEST& rhs);
    public:
...
/// This command performs ECC encryption as described in Part 1, Annex D.
/// </summary>
class _DLLEXP_ ECC_EncryptResponse : public TpmStructureBase
{
    friend class StructMarshallInfo;
    /// <summary>
    /// size of the remainder of this structure
    ...
    public: virtual TpmTypeId GetTypeId() const;
    protected: virtual void* ElementInfo(int elementIndex, int arrayIndex, int& arraySize, TpmStructureBase*& pElem, int newArraySize);
    public: ECC_EncryptResponse& operator=(const ECC_EncryptResponse& rhs);
    public: ECC_EncryptResponse(const ECC_EncryptResponse& rhs);
    public:
    ECC_EncryptResponse();
...
/// </summary>
class _DLLEXP_ TPM2_ECC_Decrypt_REQUEST : public TpmStructureBase
{
    friend class StructMarshallInfo;
    /// <summary>
    ...
    public: virtual TpmTypeId GetTypeId() const;
    protected: virtual void* ElementInfo(int elementIndex, int arrayIndex, int& arraySize, TpmStructureBase*& pElem, int newArraySize);
    public: TPM2_ECC_Decrypt_REQUEST& operator=(const TPM2_ECC_Decrypt_REQUEST& rhs);
    public: TPM2_ECC_Decrypt_REQUEST(const TPM2_ECC_Decrypt_REQUEST& rhs);
    public:
...
/// This command performs ECC decryption.
/// </summary>
class _DLLEXP_ ECC_DecryptResponse : public TpmStructureBase
{
    friend class StructMarshallInfo;
    /// <summary>
    /// size of the buffer
    ...
    public: virtual TpmTypeId GetTypeId() const;
    protected: virtual void* ElementInfo(int elementIndex, int arrayIndex, int& arraySize, TpmStructureBase*& pElem, int newArraySize);
    public: ECC_DecryptResponse& operator=(const ECC_DecryptResponse& rhs);
    public: ECC_DecryptResponse(const ECC_DecryptResponse& rhs);
    public:
    ECC_DecryptResponse();
...
class _DLLEXP_ TPM2_ACT_SetTimeout_REQUEST : public TpmStructureBase
{
    ...
    public: virtual TpmTypeId GetTypeId() const;
    protected: virtual void* ElementInfo(int elementIndex, int arrayIndex, int& arraySize, TpmStructureBase*& pElem, int newArraySize);
    public: TPM2_ACT_SetTimeout_REQUEST& operator=(const TPM2_ACT_SetTimeout_REQUEST& rhs);
    public: TPM2_ACT_SetTimeout_REQUEST(const TPM2_ACT_SetTimeout_REQUEST& rhs);
    public:
...
class _DLLEXP_ ACT_SetTimeoutResponse : public TpmStructureBase
{
    ...
    public: virtual TpmTypeId GetTypeId() const;
    protected: virtual void* ElementInfo(int elementIndex, int arrayIndex, int& arraySize, TpmStructureBase*& pElem, int newArraySize);
    public: ACT_SetTimeoutResponse& operator=(const ACT_SetTimeoutResponse& rhs);
    public: ACT_SetTimeoutResponse(const ACT_SetTimeoutResponse& rhs);
    public:
