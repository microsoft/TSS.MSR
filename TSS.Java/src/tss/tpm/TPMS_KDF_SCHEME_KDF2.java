...
public class TPMS_KDF_SCHEME_KDF2 extends TpmStructure implements TPMU_SCHEME_KEYEDHASH, TPMU_SIG_SCHEME, TPMU_KDF_SCHEME, TPMU_ASYM_SCHEME, TPMU_SIGNATURE 
{
    ...
    */
    ...
    public static TPMS_KDF_SCHEME_KDF2 fromTpm (byte[] x) 
    {
        TPMS_KDF_SCHEME_KDF2 ret = new TPMS_KDF_SCHEME_KDF2();
    ...
    public static TPMS_KDF_SCHEME_KDF2 fromTpm (InByteBuf buf) 
    {
        TPMS_KDF_SCHEME_KDF2 ret = new TPMS_KDF_SCHEME_KDF2();
        ret.initFromTpm(buf);
        return ret;
