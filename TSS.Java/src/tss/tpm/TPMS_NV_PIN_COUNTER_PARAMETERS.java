...
public class TPMS_NV_PIN_COUNTER_PARAMETERS extends TpmStructure
{
    ...
    /**
     *  @param _pinCount This counter shows the current number of successful authValue authorization attempts to
     *         access a TPM_NT_PIN_PASS index or the current number of unsuccessful authValue
     *         authorization attempts to access a TPM_NT_PIN_FAIL index.
     *  @param _pinLimit This threshold is the value of pinCount at which the authValue authorization of the host
     *         TPM_NT_PIN_PASS or TPM_NT_PIN_FAIL index is locked out.
     */
