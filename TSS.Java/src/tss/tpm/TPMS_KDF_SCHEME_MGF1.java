...
public class TPMS_KDF_SCHEME_MGF1 extends TpmStructure implements TPMU_SCHEME_KEYEDHASH, TPMU_SIG_SCHEME, TPMU_KDF_SCHEME, TPMU_ASYM_SCHEME, TPMU_SIGNATURE 
{
     ...
     */
    public TPMS_KDF_SCHEME_MGF1(TPM_ALG_ID _hashAlg)
    {
        hashAlg = _hashAlg;
    }
    /**
    ...
    */
    ...
    public static TPMS_KDF_SCHEME_MGF1 fromTpm (byte[] x) 
    {
        TPMS_KDF_SCHEME_MGF1 ret = new TPMS_KDF_SCHEME_MGF1();
    ...
    public static TPMS_KDF_SCHEME_MGF1 fromTpm (InByteBuf buf) 
    {
        TPMS_KDF_SCHEME_MGF1 ret = new TPMS_KDF_SCHEME_MGF1();
        ret.initFromTpm(buf);
        return ret;
